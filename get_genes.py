...
FILTER_STATE = "pval < 0.01 and (logfc < -1 or logfc > 1)"
...
gse_33814_cols = gse_33814[["Gene.ID", "Gene.symbol",
                            "logFC", "P.Value", "adj.P.Val"]]

gse_33814_cols.columns = ["id", "gene", "logfc", "pval", "adjpval"]
gse_33814_filtered = gse_33814_cols.query(FILTER_STATE)
# print(gse_33814_filtered.tail())
print("GSE33814 GENE LIST")
# print(len([x for x in list(gse_33814_filtered["gene"]) if str(x) != 'nan']))
for x in list(gse_33814_filtered["id"]):
    if str(x) != 'nan':
        print(x)
...
gse_37031_cols = gse_37031[["SPOT_ID", "SPOT_ID",
                            "logFC", "P.Value", "adj.P.Val"]]

gse_37031_cols.columns = ["id", "gene", "logfc", "pval", "adjpval"]
...
# print(len([x for x in list(gse_37031_filtered["gene"]) if str(x) != 'nan']))
for x in list(gse_37031_filtered["gene"]):
    if str(x) != 'nan':
        print(x)
...
gse_48452_cols = gse_48452[["Gene.ID", "Gene.symbol",
                            "logFC", "P.Value", "adj.P.Val"]]

gse_48452_cols.columns = ["id", "gene", "logfc", "pval", "adjpval"]

gse_48452_filtered = gse_48452_cols.query(FILTER_STATE)
print("GSE48452 GENE LIST")
# print(list(gse_48452_filtered["gene"]))
# print(len([x for x in list(gse_48452_filtered["gene"]) if str(x) != 'nan']))
for x in list(gse_48452_filtered["id"]):
    if str(x) != 'nan':
        print(x)
...
gse_63067_cols = gse_63067[["Gene.ID", "Gene.symbol",
                            "logFC", "P.Value", "adj.P.Val"]]

gse_63067_cols.columns = ["id", "gene", "logfc", "pval", "adjpval"]

gse_63067_filtered = gse_63067_cols.query(FILTER_STATE)
print("GSE63067 GENE LIST")
# print(list(gse_63067_filtered["gene"]))
# print(len([x for x in list(gse_63067_filtered["gene"]) if str(x) != 'nan']))
for x in list(gse_63067_filtered["id"]):
    if str(x) != 'nan':
        print(x)
...
gse_89632_cols = gse_89632[["Entrez_Gene_ID", "Symbol",
                            "logFC", "P.Value", "adj.P.Val"]]

gse_89632_cols.columns = ["id", "gene", "logfc", "pval", "adjpval"]

gse_89632_filtered = gse_89632_cols.query(FILTER_STATE)
print("GSE89632 GENE LIST")
# print(list(gse_89632_filtered["gene"]))
# print(len([x for x in list(gse_89632_filtered["gene"]) if str(x) != 'nan']))
for x in list(gse_89632_filtered["id"]):
    if str(x) != 'nan':
        print(x)
